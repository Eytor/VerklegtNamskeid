...
DataAccess::DataAccess()
{
    ...
    query.exec("CREATE TABLE IF NOT EXISTS 'DeletedComputers' ('ID' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL , 'Name' VARCHAR NOT NULL , 'Type' VARCHAR NOT NULL , 'Built' BOOL NOT NULL , 'Year' DATETIME)");
